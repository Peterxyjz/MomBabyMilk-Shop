...
const InputBills = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            sorter: (a, b) => new Date(a.inputBill.input_date) - new Date(b.inputBill.input_date),
        },
        {
            title: 'Tổng Sản Phẩm',
            key: 'total_products',
        ...
        },
        {
            title: 'Tổng Số Lượng',
            key: 'total_amount',
            render: (text, record) => record.inputBillDetails.reduce((sum, detail) => sum + detail.amount, 0),
            sorter: (a, b) => a.inputBillDetails.reduce((sum, detail) => sum + detail.amount, 0) - b.inputBillDetails.reduce((sum, detail) => sum + detail.amount, 0),
        },
        {
            title: 'Tổng Tiền',
            key: 'total_price',
        ...
        },
        {
            ...
            key: 'detail',
            render: (text) => <a href={``} className="font-medium text-cyan-600 hover:underline dark:text-cyan-500">Chi Tiết</a>,
        },
    ];

    return (
        <div style={{ display: 'flex', justifyContent: 'center', height: '80vh' }}>
            <Card title="Tất cả đơn nhập hàng" style={{ width: '90%', marginTop: '50px', height: '75vh' }}>
                <div>
