          ...
          setProfile({
            ...
            birthDate: res.data.result.date_of_birth
              ? {
                  ...
                  month: (new Date(res.data.result.date_of_birth).getMonth() + 1).toString(),
                  year: new Date(res.data.result.date_of_birth).getFullYear().toString(),
                }
              : "Chưa có ngày sinh",
          });
        })
          ...
          <div className="w-full mx-auto">
            <div className="w-full grid grid-cols-4">
              ...
              <div>
                ...
                <p className="text-lg font-semibold">{formatDate(profile.birthDate)}</p>
              </div>
              <div>
